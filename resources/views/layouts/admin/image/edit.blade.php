...
<div class="container">
    ...
    <div class="row mb-3">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              <form method="POST" action="{{ route('headimage.update',$data->id) }}"  enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body px-lg-5">
                                    ...
                                    <input type="hidden"  name="headimagepic" id="headimagepic"  value="{{ $data->pic_location }}">
